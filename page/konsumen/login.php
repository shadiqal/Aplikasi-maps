      ...
      <div class="card">
        ...
        <div class="card-body mx-4">
          ...
          <div class="text-center">
            <h3 class="dark-grey-text mb-5"><strong>Masuk</strong></h3>
          </div>

          <!--Body-->
          <div class="md-form">
            <h6>Email</h6>
            <input type="email" id="email"  title="Masukkan dengan format email" class="form-control" required>
          ...
          <div class="text-center mb-3">
            <button type="submit" id="loginBtn" class="btn blue-gradient btn-block btn-rounded z-depth-1a">Login</button>
          </div>
        ...
        <div class="modal-footer mx-5 pt-3 mb-1">
          <p class="font-small grey-text d-flex justify-content-end">Belum punya akun?<a href="daftar.php" class="blue-text ml-1">
              Daftar disini</a></p>
        </div>
