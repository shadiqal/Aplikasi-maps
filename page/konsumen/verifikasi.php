      ...
      <div class="card">
        ...
        <div class="card-body mx-4">
          ...
          <div class="text-center">
            <h3 class="dark-grey-text mb-5"><strong>Verifikasi</strong></h3>
          </div>
            <div class="text-right">
                
            <a  id="kodeBaru"><h6 class="dark-grey-text mb-5" ><strong><i class="fas fa-redo-alt"></i> Kirim kode baru</strong></h6></a>
          </div>
          <!--Body-->
          <div class="md-form">
              
            <h6></h6>
            <input type="text" id="kode" placeholder="Masukkan kode verifikasi dari sms" class="form-control" required>
          ...
          <div class="text-center mb-3">
            <button type="button" id="cek" class="btn blue-gradient btn-block btn-rounded z-depth-1a">Submit</button>
          </div>
...
<footer class="page-footer font-small mdb-color pt-4">
  ...
  <script type="text/javascript" src="../../assets/js/verifikasi.js"></script>
