        ...
        <!-- body -->    
          <div class="container">
            <div class="col-md-5 offset-md-4">
                  <section class="form-elegant"  onload="loadStatusPesanan()" id="content">
...
<footer class="page-footer font-small mdb-color pt-4">
  ...
  <script type="text/javascript" src="../../assets/js/statusPesananController.js">
     
    </script>
    <script>
    var idKonsumen = '<?php echo $idKonsumen; ?>';
loadStatusPesanan(idKonsumen);
     </script>
</body>
