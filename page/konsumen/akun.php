...
<body class="white-skin" onload="loadDataDiri()">
 <div style="height: 100vh">
  ...
  <!-- Central Modal Large Info-->
              <div class="modal fade" id="gantiNoHp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-notify modal-success" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      <p class="heading lead"><strong>Ubah no Telepon</strong></p>
                    ...
                    <!--Body-->
                    <div class="" id="loadGantiNoHp" onload="">
              ...
              <div class="modal fade" id="gantiPassword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog modal-lg modal-notify modal-success" role="document">
                  ...
                  <div class="modal-content">
                    <!--Header-->
                    <div class="modal-header">
                      <p class="heading lead"><strong>Ubah password</strong></p>
                    ...
                    <!--Body-->
                    <div class="" id="loadGantiPassword" onload="">
...
<script src="../../assets/js/akunController.js" type="text/javascript">
